...
export class TestData{
    ...
    public static products: Product[] = [
        ...
        {productoId:  2, nombre: "Cosa Dos", valorVentaConIva: 15000, cantidadUnidadesInventario: 5, porcentajeIVAAplicado: 0.10,
        ...
        isBase64Image: false},
        {productoId:  3, nombre: "Cosa Tres", valorVentaConIva: 30000, cantidadUnidadesInventario: 5, porcentajeIVAAplicado: 0.10,detalleProducto:"sdfdsfs",
        urlProducto:"https://raw.githubusercontent.com/Dev-NekoEdg/public-images/main/Xolit-images/windows10.jpg",
        isBase64Image: false},
        {
            productoId:  4, nombre: "Cosa Cuatro", valorVentaConIva: 8000, cantidadUnidadesInventario: 5, porcentajeIVAAplicado: 0.10,
